...
public class Todo extends TableImpl<TodoRecord> {
    ...
    private static final long serialVersionUID = -1057248341;
     ...
     */
    public final TableField<TodoRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_39AC261C_0C13_47E5_AA49_53265E4630BF)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
